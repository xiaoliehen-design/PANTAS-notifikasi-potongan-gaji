-- PANTAS V6 - RESET DATA PEGAWAI DAN POTONGAN
--
...
--     RESET_DATA_PEGAWAI_DAN_POTONGAN, lalu jalankan seluruh file di SQL Editor.
...
begin
  if v_confirmation <> 'RESET_DATA_PEGAWAI_DAN_POTONGAN' then
    raise exception using
      message = 'Reset dibatalkan: ubah BELUM_DIKONFIRMASI menjadi RESET_DATA_PEGAWAI_DAN_POTONGAN terlebih dahulu.';
  end if;
