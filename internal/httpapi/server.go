...
func (a *App) Handler() http.Handler {
	...
	mux.Handle("POST /api/admin/units", a.withAdmin(a.adminCreateUnit))
	mux.Handle("PATCH /api/admin/units/{id}", a.withAdmin(a.adminUpdateUnit))
	mux.Handle("DELETE /api/admin/units/{id}", a.withAdmin(a.adminDeleteUnit))
